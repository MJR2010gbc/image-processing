...
class ImageProcessing:
    ...
    filtered_magnitude_spectrum_gray : list
...
# 
    def __init__(self, image_path):
        ...
        self.image_frequency_gray = []
        self.magnitude_spectrum_gray = []
        self.filtered_image_frequency_gray = []
        self.filtered_magnitude_spectrum_gray = []
...
#    
    def recompose_image(self, matrix):
        ...
        image_back = cv2.idft(unshifted_frequency)
    ...
    def define_circular_mask(self, radius, intensity, direction):
    ...
    def create_color_list(self, color):
        color_channels = []
        if color == 1:
            ...
            color_channels.append(2)
        return color_channels
    
    def get_image_back(self, color_channels, mask):
    ...
    def sharpening(self, color):
        # Circular HPF mask, center circle is 0, remaining all ones
        mask = self.define_circular_mask(self.column_number/20, .5, 0)

        color_channels = self.create_color_list(color)
        
        self.get_image_back(color_channels, mask)

    # Edge Detection with High Pass Filter
    def blurring(self, color):
        # Circular HPF mask, center circle is 0, remaining all ones
    ...
    # Edge Detection with High Pass Filter
    def edge_detection(self, color):
        # Circular HPF mask, center circle is 0, remaining all ones
        mask = self.define_circular_mask(self.ccol/10, 0.000001, 0)
    ...
    # Edge Detection with High Pass Filter
    def noise_filtering(self, color):
        # Circular HPF mask, center circle is 0, remaining all ones
